...
public class QrCodeUtil {
    ...
    public static void encode(HttpServletResponse response, String content) throws Exception {
     ...
     * @throws Exception
     */
    private static void insertImage(BufferedImage qrImage, String imgPath, boolean needCompress) throws Exception {
        //创建远程连接，用于获取LOGO数据
